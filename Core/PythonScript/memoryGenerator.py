...
for j in range (0,9):
    for i in range (0,9):
      print ("reg [2:0] stat_X"+str(i)+"_Y"+str(j)+" = 3'd0;")
...
for q in range(0,9):
    for r in range(0,9):
        print("\t\t if(stat_X"+str(q)+"_Y"+str(r)+" == 3'd1)")
        print("\t\t\t stat_X"+str(q)+"_Y"+str(r)+" =3'd0;")
        print("\t\t else if(stat_X"+str(q)+"_Y"+str(r)+" == 3'd3)")
        print("\t\t\t stat_X"+str(q)+"_Y"+str(r)+" =3'd2;")
for i in range(0,9):
    for j in range(0,9):
        ...
        for n in range (0,2):# per le direzioni
            ...
            if n == 0:
                print("\t\t\t\tif ("+var_in_ship_dimension+"+ "+var_in_x+" <= 4'd8)//se sono fuoiri")
            else:
                print("\t\t\t\tif ("+var_in_ship_dimension+"+ "+var_in_y+" <= 4'd8)//se sono fuoiri")
            print("\t\t\t\tbegin")
            ...
            for k in  ([2,3,4]):
                ...
                while m < k:
                    if (i+m)<=8 and (j+m)<=8:
                        if n == 0:
                            print("&&(stat_X"+str(i+m)+"_Y"+str(j)+" == 3'd0) \n\t\t\t\t\t\t\t\t\t\t", end ='');
                        else:
                            print("&&(stat_X"+str(i)+"_Y"+str(j+m)+" == 3'd0) \n\t\t\t\t\t\t\t\t\t\t", end ='');
                    else:
                ...
                while m < k:
                    if (i+m)<=8 and (j+m)<=8:
                        if n == 0:
                            print("\t\t\t\t\t\t\t\tstat_X"+str(i+m)+"_Y"+str(j)+"= 3'd1;")
                        else:
                            print("\t\t\t\t\t\t\t\tstat_X"+str(i)+"_Y"+str(j+m)+"= 3'd1;")
                    else:
                        # vado fuori volutamente dal while
                        m = m + 10
                    m = m + 1
                ...
                while m < k:
                    if (i+m)<=8 and (j+m)<=8:
                        if n == 0:
                            print("\t\t\t\t\t\t\tif(stat_X"+str(i+m)+"_Y"+str(j)+" == 3'd2)")
                            print("\t\t\t\t\t\t\t\tstat_X"+str(i+m)+"_Y"+str(j)+"= 3'd3;")

                        else:
                            print("\t\t\t\t\t\t\tif(stat_X"+str(i)+"_Y"+str(j+m)+" == 3'd2)")
                            print("\t\t\t\t\t\t\t\tstat_X"+str(i)+"_Y"+str(j+m)+"= 3'd3;")
                    else:
                        # vado fuori volutamente dal while
                        m = m + 10
                    m = m + 1
                ...
                while m < k:
                    if (i+m)<=8 and (j+m)<=8:
                        if n == 0:
                            print("\t\t\t\t\t\t\t\tstat_X"+str(i+m)+"_Y"+str(j)+"= 3'd2;")
                        else:
                            print("\t\t\t\t\t\t\t\tstat_X"+str(i)+"_Y"+str(j+m)+"= 3'd2;")
                    else:
                        # vado fuori volutamente dal while
                        m = m + 10
                    m = m + 1
